...
while(check)
{
	...
	case 2:
				...
				if(patientName== null)
				{
					System.out.println("No data available for Id= "+patientId);
					break;
				}
				...
				if(returnValue==3)
				{
					...
					System.out.println("Do You Want appoinment on next Day?? y/n");
					char choice2 = (char) u.inputCharacter();
					if(choice2=='y')
					{
						jdbcDao.takeNextDayAppoinment(appoinmentModel);
						System.out.println("Your appoinment is fixed on "+nextDate);
					}
					else{
